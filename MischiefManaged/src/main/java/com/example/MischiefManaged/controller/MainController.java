...
public class MainController {
    ...
    @Autowired
    public MainController(MessageRepo messageRepo, ObjectMapper mapper) {       //ObjectMapper mapper нужен что бы инициализировать ObjectWriter
    ...
    public String main(Model model, @AuthenticationPrincipal User user) throws JsonProcessingException {
        ...
        model.addAttribute("isDevMode", "dev".equals(profile));     //проверка на то что это дев версия(информация на уровне темплэйтов)
